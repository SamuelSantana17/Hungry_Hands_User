...
class FetchMenuPollo extends StatefulWidget {
  const FetchMenuPollo({Key? key}) : super(key: key);

  @override
  State<FetchMenuPollo> createState() => _FetchDataState();
}

class _FetchDataState extends State<FetchMenuPollo> {
...
// text fields' controllers
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection('9qhkBEYUbRUUZVIsnc5V7wOdb1C3');
    ...
    try {
      ...
      if (documents.isNotEmpty) {
        ...
        await cartCollection.add({
          ...
          'totalPrice': totalPrice,
          'subTotal': itemPrice,
          'RestaurantID': '9qhkBEYUbRUUZVIsnc5V7wOdb1C3'
        });
      }
    } catch (e) {
