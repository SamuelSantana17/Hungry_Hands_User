...
class FetchMenuShake extends StatefulWidget {
  const FetchMenuShake({Key? key}) : super(key: key);

  @override
  State<FetchMenuShake> createState() => _FetchDataState();
}

class _FetchDataState extends State<FetchMenuShake> {
...
// text fields' controllers
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection('407kwFWIhvgu1J90hOaU2byMRIL2');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Shake Smart Menu')),
        actions: <Widget>[
          IconButton(
