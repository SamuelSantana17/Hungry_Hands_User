...
class FetchMenuSamba extends StatefulWidget {
  const FetchMenuSamba({Key? key}) : super(key: key);

  @override
  State<FetchMenuSamba> createState() => _FetchDataState();
}

class _FetchDataState extends State<FetchMenuSamba> {
...
// text fields' controllers
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection('IxWJPxrH91ayxzKnUWY3rJPpSWy2');
