...
class FetchMenuFry extends StatefulWidget {
  const FetchMenuFry({Key? key}) : super(key: key);

  @override
  State<FetchMenuFry> createState() => _FetchDataState();
}

class _FetchDataState extends State<FetchMenuFry> {
...
// text fields' controllers
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection('pEaPO3on3BaLl57K9PKYqaCeTHd2');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Fry Shack Menu')),
        actions: <Widget>[
          Stack(
            children: <Widget>[
              IconButton(
