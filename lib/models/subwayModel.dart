...
class FetchMenuSub extends StatefulWidget {
  const FetchMenuSub({Key? key}) : super(key: key);

  @override
  State<FetchMenuSub> createState() => _FetchDataState();
}

class _FetchDataState extends State<FetchMenuSub> {
...
// text fields' controllers
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection('lbDeUSsDfrg1vTlyztrFr8I7sGD3');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Subway Menu')),
        actions: <Widget>[
          Stack(
            children: <Widget>[
              IconButton(
